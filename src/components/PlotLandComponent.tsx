...
import plotPropertyData from "../data/PlotPropertyData.json";
import useEmblaCarousel from "embla-carousel-react";
import Autoplay from "embla-carousel-autoplay";
import PropertyCardComponent from "./PropertyCardComponent";
import { ChevronLeft, ChevronRight } from 'lucide-react';

const PlotLandComponent: React.FC = () => {
  ...
  return (
    <div className='py-4'>
      ...
      <div className="heading">
        <h1 className='text-2xl font-bold mx-4 my-8'> Ongoing Land Projects</h1>
      </div>
      <div className="embla">
